#ifndef PPMFILTERGRAYSCALECONVERTE_HPP
#define PPMFILTERGRAYSCALECONVERTE_HPP
...
public:
    ...
    quint32 apply(PPMpicture& picture_in,
...
quint32 GrayscaleConverter::apply(PPMpicture &picture_in,
                                  QVector<quint32> &vector_out)
{
